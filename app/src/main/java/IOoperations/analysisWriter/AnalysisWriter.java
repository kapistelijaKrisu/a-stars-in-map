...
public class AnalysisWriter {
    ...
    public void writeReport(Map<String, String> replacingValues, String path) throws IOException, IllegalArgumentException {
        if (AnalysisWriter.reportValidator.validateMapper((replacingValues)) == false || path == null) throw new IllegalArgumentException(AnalysisWriter.reportValidator.getValidatorCondition());
